...
class TestLiftedMulticutWorkflow(unittest.TestCase):
    ...
    def _check_result(self):
        mc_path = self.tmp_folder + '/lmc.n5'
    ...
    def test_workflow(self):
        max_jobs = 8
        mc_path = self.tmp_folder + '/lmc.n5'
        ret = luigi.build([LiftedMulticutSegmentationWorkflow(input_path=self.input_path,
                                                              ...
                                                              output_path=mc_path,
                                                              output_key='volumes/lifted_multicut',
                                                              lifted_labels_path=self.input_path,
                                                              lifted_labels_key='volumes/test_labels',
                                                              lifted_prefix='test',
                                                              n_scales=1,
                                                              skip_ws=True,
