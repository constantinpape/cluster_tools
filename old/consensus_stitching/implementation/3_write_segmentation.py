...
def write_block(ds_ws, ds_out, blocking, block_id, node_labels):
...
def step3(path, ws_key, out_key, cache_folder, job_id):
    ...
    with open(input_file) as f:
        ...
        block_shape = input_config['config']['block_shape']
    ...
    [write_block(ds_ws, ds_out, blocking, block_id, node_labels) for block_id in block_ids]
    print("Success")
...
if __name__ == '__main__':
    ...
    step3(args.path, args.ws_key, args.out_key,
